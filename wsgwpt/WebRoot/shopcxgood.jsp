			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">查询商品</strong> / <small>Ck good</small></div>
					</div>
					<hr/>
					<!--修改框-->				
					<div class="am-form-group">
					<form name="form" class="am-form am-form-horizontal" action="./CkGoodServlet"   accept-charset="utf-8">
							<label for="user-new-password" class="am-form-label">请输入要查询的商品编号</label>
