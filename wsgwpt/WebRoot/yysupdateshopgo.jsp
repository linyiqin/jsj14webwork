		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<hr/>
					<!--修改框-->		
					<form name="form" class="am-form am-form-horizontal" action="./UpdateShopServlet" accept-charset="utf-8">		
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">店铺名称</label>
							<div class="am-form-content">
								 <input type="text" readonly name="name" id="name" value="${shop.shop_name} ">
								 <input type="hidden" name="method" id="method" value="yys"><br>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">店主名</label>
							<div class="am-form-content">
								<input type="text"  name="username" id="username" value="${shop.shop_username}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">店铺联系方式</label>
							<div class="am-form-content">
								  <input type="text"  name="tel" id="tel" value="${shop.shop_usertel}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">店铺地址</label>
							<div class="am-form-content">
								  <input type="text"  name="address" id="address" value="${shop.shop_useraddress}">
							</div>
						</div>
