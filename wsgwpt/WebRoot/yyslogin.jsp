	...
	<body>
		...
		<div class="login-banner">
			<div class="login-main">
				...
				<div class="login-box">
							<h3 class="title">小二登录</h3>

							<div class="clear"></div>
						
						<div class="login-form">
						   <form name="form" action="./YYSloginServlet" onSubmit="return check()"  accept-charset="utf-8">
								   <input type="text" name="name" id="name" placeholder="小二名"><br>
