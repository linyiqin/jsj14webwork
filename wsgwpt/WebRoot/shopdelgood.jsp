			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">删除商品</strong> / <small>Del good</small></div>
					</div>
					<hr/>
					<!--修改框-->				
					<div class="am-form-group">
					<form name="form" class="am-form am-form-horizontal" action="./DelGoodServlet"   accept-charset="utf-8">
							<label for="user-new-password" class="am-form-label">请输入要删除的商品编号</label>
