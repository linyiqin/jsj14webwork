				...
				<div class="main-wrap">
					<div class="wrap-left">
						<div class="wrap-list">
							...
							<div class="you-like">
								<div class="s-bar">
									<a class="am-badge am-badge-danger am-round">全部顾客</a>
							...
							<%
								...
								ResultSet as = stmt.executeQuery("select * from user");
								while (as.next()) {
							%>
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												<a  class="s-pic-link">名字:<%= as.getString("user_name") %></a><br>
												<a  class="s-pic-link">真实名字:<%= as.getString("user_truename") %></a><br>
												<a  class="s-pic-link">联系方式:<%= as.getString("user_tel") %></a><br>
												<a  class="s-pic-link">地址:<%= as.getString("user_address") %></a><br>
											</div>
										</div>
									</div>
