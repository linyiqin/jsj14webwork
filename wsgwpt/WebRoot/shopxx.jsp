			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">店铺信息</strong> / <small>shop</small></div>
					</div>
					<hr/>
					<!--修改框-->
					<form name="form" class="am-form am-form-horizontal" action="" onSubmit="return check()"  accept-charset="utf-8">
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">店铺名</label>
							<div class="am-form-content">
							<% String flagname2 = (String)session.getAttribute("shopflag"); %>
								 <input type="text" readonly name="name" id="name" value="<%= flagname2 %>"><br>
							</div>
						</div>
						<%
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" readonly name="text" id="text" value="<%= as.getString("shop_username")%>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">联系方式</label>
							<div class="am-form-content">
								  <input type="text" readonly name="text" id="text" value="<%= as.getString("shop_usertel")%>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">地址</label>
							<div class="am-form-content">
								  <input type="text" readonly name="text" id="text" value="<%= as.getString("shop_useraddress")%>">
							</div>
						</div>
						<% } %>
					</form>
