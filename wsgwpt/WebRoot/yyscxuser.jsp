			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">查询顾客</strong> / <small>Ck User</small></div>
					</div>
					<hr/>
					<!--修改框-->				
					<div class="am-form-group">
					<form name="form" class="am-form am-form-horizontal" action="./CkUserServlet"   accept-charset="utf-8">
							<label for="user-new-password" class="am-form-label">请输入要查询的顾客名称</label>
