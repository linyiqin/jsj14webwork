			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">删除顾客信息</strong> / <small>Del User</small></div>
					</div>
					<hr/>
					<!--修改框-->
					<form name="form" class="am-form am-form-horizontal" action="./DelUserServlet" onSubmit="return check()"  accept-charset="utf-8">
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">请输入要删除的顾客名称</label>
							<div class="am-form-content">
								 <input type="text" name="name" id="name" value=""><br>
							</div>
						</div>			
						<div class="info-btn" align="center">
							 <input type="submit" name="" value="确定删除" > 
						</div>
