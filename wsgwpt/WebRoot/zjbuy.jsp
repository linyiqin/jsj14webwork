...
<body>
		...
		<div class="center">
		   ...
		   Class.forName("com.mysql.jdbc.Driver");
			...
			ResultSet as = stmt.executeQuery("select * from goods_imformation where goods_id = '"+id+"'");
			while (as.next()) {
		%>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">商品编号</label>
							<div class="am-form-content">
								<input type="text" id="goods_id" name="goods_id" readonly="true" value="<%= as.getString("goods_id")%>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品名称</label>
							<div class="am-form-content">
								<input type="text" id="goods_name" name="goods_name" readonly="true" value="<%= as.getString("goods_name")%>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品数量</label>
							<div class="am-form-content">
								<input type="text" id="goods_amount" name="goods_amount" readonly="true" value="1">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品类型</label>
							<div class="am-form-content">
								<input type="text" id="order_state" name="order_state" readonly="true" value="<%= as.getString("goods_type")%>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品单价</label>
							<div class="am-form-content">
								<input type="text" id="good_price" name="good_price" readonly="true" value=" <%= as.getDouble("good_price")%> ">
							</div>
						</div>
					<%
						}
					...
					<div class="am-form-group">
						...
						<div class="info-btn" align="center">
							 ...
							 &nbsp;
							 <input type="button" style="color:bule" value="返回上一页" onclick="javascript:history.go(-1);" /><br>
							 <a>&nbsp;&nbsp;</a>
						</div>
