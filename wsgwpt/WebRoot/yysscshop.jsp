			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">删除店铺信息</strong> / <small>Del shop</small></div>
					</div>
					<hr/>
					<!--修改框-->
					<form name="form" class="am-form am-form-horizontal" action="./DelShopServlet" onSubmit="return check()"  accept-charset="utf-8">
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">请输入要删除的店铺名称</label>
