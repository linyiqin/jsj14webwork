			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">订单查询</strong> / <small>Ck order</small></div>
					</div>
					<hr/>
					<!--修改框-->				
					<div class="am-form-group">
					<form name="form" class="am-form am-form-horizontal" action="./CkOrderServlet"   accept-charset="utf-8">
							<label for="user-new-password" class="am-form-label">请输入要查询的订单号</label>
							<div class="am-form-content">
								 <input type="text" name="id" id="id" value="">
								 <input type="hidden" name="method" id="method" value="cx"><br>
							</div>
							<div class="info-btn" align="center">
							 <input type="submit" name="" value="确定查询" > 
						</div>
						</div>
						</form>
				</div>
