				...
				<div class="main-wrap">
					<div class="wrap-left">
						<div class="wrap-list">
							...
							<div class="you-like">
								<div class="s-bar">
									<a class="am-badge am-badge-danger am-round">全部商品</a>
							...
							<%
								...
								ResultSet as = stmt.executeQuery("select * from goods_imformation");
								while (as.next()) {
							%>
									<div class="s-item-wrap">
										<div class="s-item">
											...
											<div class="s-pic">
												...
												<a  class="s-pic-link">库存:<%= as.getString("goods_amount") %></a><br>
												<a  class="s-pic-link">类型:<%= as.getString("goods_type") %></a><br>
												<a  class="s-pic-link">价格:<%= as.getDouble("good_price") %></a><br>
											</div>
										</div>
									</div>
