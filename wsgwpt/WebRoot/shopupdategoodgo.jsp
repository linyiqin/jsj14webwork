			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">修改信商品息</strong> / <small>update good</small></div>
					</div>
					<hr/>
					<!--修改框-->		
					<form name="form" class="am-form am-form-horizontal" action="./UpdateGoodServlet" accept-charset="utf-8">		
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">商品编号</label>
							<div class="am-form-content">
								 <input type="text" readonly name="goods_id" id="goods_id" value="${good.goods_id} "><br>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">商品名</label>
							<div class="am-form-content">
								<input type="text"  name="goods_name" id="goods_name" value="${good.goods_name}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品类型</label>
							<div class="am-form-content">
								  <input type="text"  name="goods_type" id="goods_type" value="${good.goods_type}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">商品库存</label>
							<div class="am-form-content">
								  <input type="text"  name="goods_amount" id="goods_amount" value="${good.goods_amount}">
							</div>
						</div>
					<div class="am-form-group">
							...
							<div class="info-btn" align="center"><br>
							 <input type="submit" name="" value="确定修改" > 
						</div>
						</div>
						</form>
				</div>
