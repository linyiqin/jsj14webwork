			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">查询到以下信息</strong> / <small>Ck order</small></div>
					</div>
					<hr/>
					<!--修改框-->		
					...
					<div class="am-form-group">
							...
							<div class="am-form-content">
								 <input type="text" readonly name="name" id="name" value="${order.order_id} "><br>
							</div>
						</div>	
					<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">商品编号</label>
							<div class="am-form-content">
								 <input type="text" readonly name="name" id="name" value="${order.goods_id} "><br>
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">商品名</label>
							<div class="am-form-content">
								<input type="text" readonly name="username" id="username" value="${order.goods_name}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">订单商品类型</label>
							<div class="am-form-content">
								  <input type="text" readonly name="tel" id="tel" value="${order.order_state}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">订单商品数量</label>
							<div class="am-form-content">
								  <input type="text" readonly name="address" id="address" value="${order.order_amount}">
							</div>
						</div>
					<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">订单价格</label>
							<div class="am-form-content">
								  <input type="text" readonly name="address" id="address" value="${order.order_price}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">收货人</label>
							<div class="am-form-content">
								  <input type="text" readonly name="address" id="address" value="${order.user_name}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">联系方式</label>
							<div class="am-form-content">
								  <input type="text" readonly name="address" id="address" value="${order.user_tel}">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">收货地址</label>
							<div class="am-form-content">
								  <input type="text" readonly name="address" id="address" value="${order.user_address}">
							</div>
						</div>
						</form>
				</div>
